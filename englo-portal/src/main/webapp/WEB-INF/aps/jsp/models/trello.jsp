            ...
            <header id="rowChild49648" class="flexChild columnParent">
               ...
               <figure id="columnChild2835" class="flexChild logo">
                  ...
                  <div id="accordion">
                     ...
                     <h3 style="color: #3399cc !important;" class="non"onclick="location.href = '<wp:url page="trello"/>';">Trello</h3>
                     <div class="non">
                        <!--                        <p >Add a Card </p>-->
                     </div>

                     <h3 class="non"onclick="location.href = '<wp:url page="jenkins"/>';">Jenkins</h3>
                     <div class="non">
                        <p>Add New Job </p>
                        <p>Info Server </p>
                     </div>
